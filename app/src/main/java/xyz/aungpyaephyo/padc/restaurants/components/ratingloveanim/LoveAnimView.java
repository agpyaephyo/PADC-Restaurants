package xyz.aungpyaephyo.padc.restaurants.components.ratingloveanim;
 ...
 */
public class LoveAnimView extends FrameLayout implements View.OnClickListener {
    ...
    public LoveAnimView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_component_love_anim, this, true);
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        ivStar.setImageResource(isChecked ? R.drawable.ic_app_rating_36dp : R.drawable.ic_app_rating_border_24dp);
